...
const logger = winston.createLogger({
  ...
  format: logFormat,
  defaultMeta: { service: 'ai-cold-calling' },
  transports: [
...
// Export logger and component loggers
module.exports = logger;
module.exports.createComponentLogger = createComponentLogger;
module.exports.twilioLogger = createComponentLogger('twilio');
module.exports.openaiLogger = createComponentLogger('openai');
module.exports.sheetsLogger = createComponentLogger('sheets');
module.exports.callLogger = createComponentLogger('call');
