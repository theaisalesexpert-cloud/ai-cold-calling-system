...
router.get('/detailed', catchAsync(async (req, res) => {
  ...
  try {
    ...
    healthChecks.services.deepgram = deepgramHealth;
  } catch (error) {
    healthChecks.services.deepgram = {
      status: 'unhealthy',
      message: error.message
    };
  }
  ...
  try {
    ...
    healthChecks.services.elevenlabs = elevenlabsHealth;
  } catch (error) {
    healthChecks.services.elevenlabs = {
      status: 'unhealthy',
      message: error.message
    };
  }
